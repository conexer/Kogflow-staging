 ...
 * Replacement for ImageModal to fix caching issues.
 */
...
export function EditImageModal({ resultUrl, originalUrl, isOpen, onClose, user }: ImageModalProps) {
        ...
        >
            ...
            >
                ...
                <div className="flex items-center justify-between p-4 border-b border-border/40">
                    <h3 className="font-semibold text-lg">Image Details v2 (Fixed)</h3>
